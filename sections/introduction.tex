...
\begin{itemize}
    ...
    \item{} Modern digital steganography entered the world in 1985 with the
        ...
        \begin{itemize*}
            \item Concealing messages within the lowest bits of noisy image or
                sound files.
            \item Changing the order of elements in a set.
            \item Modifying the echo of a sound file (Echo Steganography) and
                so on.
        \end{itemize*}
\end{itemize}
